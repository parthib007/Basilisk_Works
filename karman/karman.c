...
//introducing view.h functions

event viewing (i += 4; t<=15.)
{
	scalar omega[];
  vorticity (u, omega);
//	view (width = 400, height = 400, fov =20, tx = -0.5, quat = {0, 0, -0.707, 0.707}); // vort going upwards
	view ( fov =20, ty = -0.5, quat = {0, 0, -0.707, 0.707}); 
	draw_vof ("f", lw = 2); //lw is color defining line width
