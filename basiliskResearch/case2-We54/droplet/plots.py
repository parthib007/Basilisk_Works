...
# */
# 
# //for specific values of the dimensionless ratios, the kinetic energy of the system increases as the droplet advects trough the domain
# //This is unexpected as there was only supposed to be a viscous drainage of energy due to the finite Reynoldsnumber.
# //algorithm is forced to adapt all interfacial cells to the maximum level of refinement
# //by using a dummy field (ff) that uses the default bilinear prolongation technique.
...
#       ff[] = f[];
#     boundary({ff});
#     adapt_wavelet((scalar *){f,u}, (double []){1e-2,uemax,uemax,uemax}, maxlevel);
...
# 
# 
# event viewing (i += 1000; t <= MAXTIME) {
